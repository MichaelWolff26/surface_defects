...
class ResNET_based(nn.Module):
    def __init__(self, Residualblock, num_block1, num_block2, num_block3):
        ...
        self.conv_transition0 = nn.Conv2d(
            in_channels=3, out_channels=32, kernel_size=7, stride=2, padding=0
        )
        ...
        self.conv_transition1 = nn.Conv2d(
            in_channels=32, out_channels=64, kernel_size=7, stride=2, padding=0
        )
        self.reluc2=nn.ReLU()
        self.block2_list = []
        ...
        self.conv_transition2 = nn.Conv2d(
            in_channels=64, out_channels=128, kernel_size=7, stride=2, padding=0
        )
        self.reluc3=nn.ReLU()
        self.block3_list = []
